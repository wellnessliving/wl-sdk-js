 ...
 * @constructor
 */
function Thoth_WlPay_Bank_Ach_ListModel()
{
   ...
   *
   * @get result
   * @type {Thoth_WlPay_Bank_Ach_ListModel_a_list[]}
   */
...
WlSdk_ModelAbstract.extend(Thoth_WlPay_Bank_Ach_ListModel);
...
/**
 * @function
 * @name Thoth_WlPay_Bank_Ach_ListModel.instanceGet
 ...
 * @returns {Thoth_WlPay_Bank_Ach_ListModel}
 ...
 *
 * @function
 * @name Thoth_WlPay_Bank_Ach_ListModel.get
