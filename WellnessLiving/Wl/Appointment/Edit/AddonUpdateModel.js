...
function Wl_Appointment_Edit_AddonUpdateModel()
{
   ...
   * ([AddonUpdateApi](/Wl/Appointment/Edit/AddonUpdate.json) is null). User key '-1' means walk-in, user key '0' means new user
  ...
  /**
   * Location key.
   * Not empty only when getting add-ons for new appointment ([AddonUpdateApi](/Wl/Appointment/Edit/AddonUpdate.json) is null).
   *
   * @get get
   * @type {string}
   */
