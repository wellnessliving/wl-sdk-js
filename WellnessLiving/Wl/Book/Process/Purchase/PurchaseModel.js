...
function Wl_Book_Process_Purchase_PurchaseModel()
{
   ...
   * @property {Wl_Book_Process_Purchase_PurchaseModel_a_purchase_a_installment_template_a_visit_limit[]} [a_visit_limit] This is only set for Purchase Options. A list of limits on booking by the Purchase Option. Every element has the next keys:
