 ...
 * @param {string} k_service The service key used to select available Purchase Options. If multiple services are selected, they should be specified in `a_service` array.
 ...
 * @param {?string} k_timezone The timezone key for `dt_date`. Can be `null` if timezone is not selected. If not selected, the default client timezone will be used. In any case, the timezone will be used if the business allows client timezones.
