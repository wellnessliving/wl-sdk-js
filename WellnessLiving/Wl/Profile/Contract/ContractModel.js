...
function Wl_Profile_Contract_ContractModel()
{
   ...
   * Optional if {@link Wl_Profile_Contract_ContractModel} is not empty.
   *
   * @get get
   ...
   * The item key. Depends on {@link Wl_Profile_Contract_ContractModel} property.
   *
   * @get get
   * @type {string}
   */
 ...
 * @param {number} id_purchase_item The type of purchase item. This is one of the {@link RsPurchaseItemSid} constants. Optional if {@link Wl_Profile_Contract_ContractModel} is not empty.
 * @param {string} k_id The key of the purchase item in the database. The item key. Depends on {@link Wl_Profile_Contract_ContractModel} property.
