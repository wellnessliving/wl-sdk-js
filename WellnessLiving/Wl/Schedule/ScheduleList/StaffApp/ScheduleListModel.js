...
function Wl_Schedule_ScheduleList_StaffApp_ScheduleListModel()
{
   ...
   * @property {Wl_Schedule_ScheduleList_StaffApp_ScheduleListModel_a_schedule_a_quiz} a_quiz List of quizzes.
   * Has next structure:
   *
   *
   ...
   * @property {number} i_addon The number of addons for the current appointment.
   ...
   * @property {number} id_option Appointment title display style.
   *  Set only for appointments, for others it will be equal to 0.
   *  Constants from {@link Wl_Schedule_Design_OptionSid}.
   ...
   * @property {boolean} is_class_view `true` if this class or event session is visible only through the "View other staff schedules"
   ...
   * For classes always <tt>null</tt>.
   * @property {boolean} is_ticket `true` if the session belongs to a ticketed event, `false` otherwise.
   ...
   * @property {string} dt_confirm Confirmation date for appointment in MySQL format. Will be zero date + time in case appointment
...
{
  return {"a_field": {"a_config": {"get": {"get": true}},"a_schedule": {"get": {"result": true}},"dl_end": {"get": {"get": true}},"dl_start": {"get": {"get": true}},"dt_date": {"get": {"get": true}},"is_virtual_service": {"get": {"result": true}},"k_business": {"delete": {"get": true},"get": {"get": true},"post": {"get": true},"put": {"get": true}},"uid": {"delete": {"get": true},"get": {"get": true},"post": {"get": true},"put": {"get": true}}}};
};
