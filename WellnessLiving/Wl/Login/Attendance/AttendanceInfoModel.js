...
function Wl_Login_Attendance_AttendanceInfoModel()
{
   ...
   * @property {Wl_Login_Attendance_AttendanceInfoModel_a_resource_layout_a_client} a_client List of clients who occupy assets of class. It is a double nesting array. Keys -  Sub keys - asset index. Values - sub array with keys:
 ...
 *
 * @function
 * @name Wl_Login_Attendance_AttendanceInfoModel.get
