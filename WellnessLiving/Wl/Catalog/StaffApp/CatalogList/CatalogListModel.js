...
function Wl_Catalog_StaffApp_CatalogList_CatalogListModel()
{
   ...
   * @property {string[]} a_location The list of location keys where the current sale item is available.
   ...
   * @property {number} [id_program] The program ID, set for promotions. One of the {@link Wl_WlProgramSid} constants.
