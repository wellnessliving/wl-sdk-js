...
function Wl_Pay_Bank_Card_ListModel()
{
  ...
  /**
   * List of bank cards.
   * Duplicate of {@link Thoth_WlPay_Bank_Card_ListModel.a_bank_card} as a flat indexed array.
   *
   * @get result
   * @type {Wl_Pay_Bank_Card_ListModel_a_list[]}
   */
 ...
 *
 * @function
 * @name Wl_Pay_Bank_Card_ListModel.get
