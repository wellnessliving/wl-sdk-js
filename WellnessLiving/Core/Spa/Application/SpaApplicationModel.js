...
function Core_Spa_Application_SpaApplicationModel()
{
   ...
   * @type {boolean}
   */
  this.is_facebook_android = undefined;
...
{
  return {"a_field":{"is_apple":{"get":{"result":true}},"is_facebook":{"get":{"result":true}},"is_facebook_android":{"get":{"result":true}},"is_google":{"get":{"result":true}},"is_microsoft":{"get":{"result":true}},"is_register_deny":{"get":{"result":true}},"is_social":{"get":{"result":true}},"is_tjx":{"get":{"result":true}},"s_application":{"get":{"get":true}},"text_tjx_button_name":{"get":{"result":true}},"url_facebook":{"get":{"result":true}},"url_tjx":{"get":{"result":true}}}};
};
 ...
 *
 * @function
 * @name Core_Spa_Application_SpaApplicationModel.get
