...
function Wl_Pay_Address_Widget_WidgetEditModel()
{
  ...
  /**
   * @typedef {{}} Wl_Pay_Address_Widget_WidgetEditModel_a_geo_a_region
  ...
  /**
   * @typedef {{}} Wl_Pay_Address_Widget_WidgetEditModel_a_geo
   * @property {Wl_Pay_Address_Widget_WidgetEditModel_a_geo_a_region} a_region List of geographic regions within the country. Each element:
   ...
   *
   * @get result
   * @type {Wl_Pay_Address_Widget_WidgetEditModel_a_geo[]}
   */
 ...
 *
 * @function
 * @name Wl_Pay_Address_Widget_WidgetEditModel.get
