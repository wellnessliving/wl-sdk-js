 ...
 * @constructor
 */
function Thoth_WlPay_Account_AccountModel()
{
   ...
   *
   * @get result
   * @type {Thoth_WlPay_Account_AccountModel_a_account}
   */
   ...
   *
   * @get result
   * @type {Thoth_WlPay_Account_AccountModel_a_account_nx[]}
   */
...
WlSdk_ModelAbstract.extend(Thoth_WlPay_Account_AccountModel);

/**
 * @inheritDoc
 */
Thoth_WlPay_Account_AccountModel.prototype.config=function()
{
...
/**
 * @function
 * @name Thoth_WlPay_Account_AccountModel.instanceGet
 ...
 * @returns {Thoth_WlPay_Account_AccountModel}
