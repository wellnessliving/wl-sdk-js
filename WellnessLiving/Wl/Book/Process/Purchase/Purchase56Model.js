...
function Wl_Book_Process_Purchase_Purchase56Model()
{
  ...
  /**
   * @typedef {{}} Wl_Book_Process_Purchase_Purchase56Model_a_login_promotion_a_restrict
  ...
  /**
   * @typedef {{}} Wl_Book_Process_Purchase_Purchase56Model_a_login_promotion_a_restrict_data
   ...
   * @property {string[]} a_uid_share List of UIDs of users who share this promotion. List of those passed in the [PurchaseApi](/Wl/Book/Process/Purchase/Purchase.json) array.
  ...
  /**
   * @typedef {{}} Wl_Book_Process_Purchase_Purchase56Model_a_purchase_a_visit_limit
   ...
   * @property {Wl_Book_Process_Purchase_Purchase56Model_a_purchase_a_visit_limit} a_visit_limit This is only set for Purchase Options. A list of limits on booking by the Purchase Option. Every element has the next keys:
