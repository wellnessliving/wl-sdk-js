 ...
 * @constructor
 */
function Thoth_WlPay_Bank_Card_Widget_WidgetSelectModel()
{
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Bank_Card_Widget_WidgetSelectModel_a_pay_card
   ...
   *
   * @get result
   * @type {Thoth_WlPay_Bank_Card_Widget_WidgetSelectModel_a_pay_card}
   */
...
WlSdk_ModelAbstract.extend(Thoth_WlPay_Bank_Card_Widget_WidgetSelectModel);
...
/**
 * @function
 * @name Thoth_WlPay_Bank_Card_Widget_WidgetSelectModel.instanceGet
 ...
 * @returns {Thoth_WlPay_Bank_Card_Widget_WidgetSelectModel}
 ...
 *
 * @function
 * @name Thoth_WlPay_Bank_Card_Widget_WidgetSelectModel.get
