...
function Wl_Pay_Processor_StripeCom_StripeComPayInitModel()
{
  ...
  /**
   * @typedef {{}} Wl_Pay_Processor_StripeCom_StripeComPayInitModel_a_card_a_pay_address
  ...
  /**
   * @typedef {{}} Wl_Pay_Processor_StripeCom_StripeComPayInitModel_a_card
   * @property {Wl_Pay_Processor_StripeCom_StripeComPayInitModel_a_card_a_pay_address} a_pay_address Payment address for address edit widget. Used only if `is_new` is `true`:
   ...
   *
   * @post post
   * @type {?Wl_Pay_Processor_StripeCom_StripeComPayInitModel_a_card}
   */
  this.a_card = null;
 ...
 *
 * @function
 * @name Wl_Pay_Processor_StripeCom_StripeComPayInitModel.post
