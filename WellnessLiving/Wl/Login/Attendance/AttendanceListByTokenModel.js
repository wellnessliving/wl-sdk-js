...
function Wl_Login_Attendance_AttendanceListByTokenModel()
{
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_info_a_icon
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_info_a_vaccination_status
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_info_a_note
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_info
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_info_a_icon} a_icon List of icons with additional information about business member.
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_resource
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_wait_confirm
   ...
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_info} a_info Information about member.
   ...
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_progress} a_progress Information about a user's current progress. By default, this information isn't sent.
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_quiz} a_quiz Quiz information that concerns current visit.
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_resource} a_resource A list of information for any associated resources for this visit. Each element:
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_wait_confirm} a_wait_confirm The date and time when the client transitioned from the wait list to the active list, in human-readable format. Empty array if the visit is not awaiting confirmation. Each element:
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_active_a_wearable} a_wearable A list of information pertaining to the client's wearables.
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_info_a_icon
   * @property {string} s_color_background Color of background.
   * @property {string} s_color_foreground Color of letter.
   * @property {string} s_letter Icon letter.
   * @property {string} s_shape Symbol from font of shapes.
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_info_a_vaccination_status
   * @property {string} sid_vaccination_status Vaccination status sid. Result from {@link Wl_Login_Member_VaccinationStatus_VaccinationStatusSid} method.
   * @property {string} text_vaccination_status Vaccination status.
   */

  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_info_a_note
   * @property {string} html_note HTML text ready to be pasted in browser.
   * @property {boolean} is_flag `true` if this note has a flag; `false` otherwise.
   */

  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_info
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_info_a_icon} a_icon List of icons with additional information about business member.
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_photo
   * @property {number} i_height The height of the photo.
   * @property {number} i_width The width of the photo.
   * @property {boolean} is_empty This will be `true` if a photo hasn't been set yet.
   * @property {string} s_url The URL of the photo.
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_resource
   * @property {number} i_index Index of the resource among multiple assets. `0` if the resource was booked from the wait list.
   * @property {string} k_resource Resource key.
   * @property {string} text_alias Resource layout alias.
   * @property {string} text_title Resource title.
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_wait_confirm
   * @property {string} s_day The formatted date string (for example, "Monday, Nov 08, 2021").
   * @property {string} s_time The formatted time string (for example, "10:00 AM").
   */
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_info} a_info Information about member.
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_photo} a_photo Information about the user's photo. The information returned has the following structure:
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_progress} a_progress Information about a user's current progress. By default, this information isn't sent.
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_quiz} a_quiz Quiz information that concerns current visit.
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_resource} a_resource A list of information for any associated resources for this visit. Each element:
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_wait_confirm} a_wait_confirm The date and time when the client transitioned from the wait list to the active list, in human-readable format. Empty array if the visit is not awaiting confirmation. Each element:
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm_a_wearable} a_wearable A list of information pertaining to the client's wearables.
   * @property {boolean} can_profile If `true`, the current user can access this client profile.
   * @property {string} dt_book The date the session was booked, in UTC.
   * @property {string} dt_date The date of the session, in UTC.
   * @property {string} dt_expire The date the Purchase Option that was used will expire, in UTC.
   ...
   *
   * @get result
   * @type {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_confirm[]}
   */
  this.a_list_confirm = undefined;

  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_info_a_icon
   * @property {string} s_color_background Color of background.
   * @property {string} s_color_foreground Color of letter.
   * @property {string} s_letter Icon letter.
   * @property {string} s_shape Symbol from font of shapes.
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_info_a_vaccination_status
   * @property {string} sid_vaccination_status Vaccination status sid. Result from {@link Wl_Login_Member_VaccinationStatus_VaccinationStatusSid} method.
   * @property {string} text_vaccination_status Vaccination status.
   */

  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_info_a_note
   * @property {string} html_note HTML text ready to be pasted in browser.
   * @property {boolean} is_flag `true` if this note has a flag; `false` otherwise.
   */

  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_info
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_info_a_icon} a_icon List of icons with additional information about business member.
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_photo
   * @property {number} i_height The height of the photo.
   * @property {number} i_width The width of the photo.
   * @property {boolean} is_empty This will be `true` if a photo hasn't been set yet.
   * @property {string} s_url The URL of the photo.
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_resource
   * @property {number} i_index Index of the resource among multiple assets. `0` if the resource was booked from the wait list.
   * @property {string} k_resource Resource key.
   * @property {string} text_alias Resource layout alias.
   * @property {string} text_title Resource title.
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_wait_confirm
   * @property {string} s_day The formatted date string (for example, "Monday, Nov 08, 2021").
   * @property {string} s_time The formatted time string (for example, "10:00 AM").
   */
  ...
  /**
   * @typedef {{}} Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_info} a_info Information about member.
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_photo} a_photo Information about the user's photo. The information returned has the following structure:
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_progress} a_progress Information about a user's current progress. By default, this information isn't sent.
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_quiz} a_quiz Quiz information that concerns current visit.
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_resource} a_resource A list of information for any associated resources for this visit. Each element:
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_wait_confirm} a_wait_confirm The date and time when the client transitioned from the wait list to the active list, in human-readable format. Empty array if the visit is not awaiting confirmation. Each element:
   * @property {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait_a_wearable} a_wearable A list of information pertaining to the client's wearables.
   * @property {boolean} can_profile If `true`, the current user can access this client profile.
   * @property {string} dt_book The date the session was booked, in UTC.
   * @property {string} dt_date The date of the session, in UTC.
   * @property {string} dt_expire The date the Purchase Option that was used will expire, in UTC.
   ...
   *
   * @get result
   * @type {Wl_Login_Attendance_AttendanceListByTokenModel_a_list_wait[]}
   */
 ...
 *
 * @function
 * @name Wl_Login_Attendance_AttendanceListByTokenModel.get
