 ...
 * @constructor
 */
function Thoth_WlPay_Method_ListModel()
{
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Method_ListModel_a_pay_method
   ...
   *
   * @get result
   * @type {Thoth_WlPay_Method_ListModel_a_pay_method[]}
   */
...
WlSdk_ModelAbstract.extend(Thoth_WlPay_Method_ListModel);

/**
 * @inheritDoc
 */
Thoth_WlPay_Method_ListModel.prototype.config=function()
{
...
/**
 * @function
 * @name Thoth_WlPay_Method_ListModel.instanceGet
 ...
 * @returns {Thoth_WlPay_Method_ListModel}
 ...
 *
 * @function
 * @name Thoth_WlPay_Method_ListModel.get
