...
function Wl_Pay_Processor_CyberSource_CsPaSetupModel()
{
  ...
  /**
   * @typedef {{}} Wl_Pay_Processor_CyberSource_CsPaSetupModel_a_card_a_pay_address
  ...
  /**
   * @typedef {{}} Wl_Pay_Processor_CyberSource_CsPaSetupModel_a_card
   * @property {Wl_Pay_Processor_CyberSource_CsPaSetupModel_a_card_a_pay_address} a_pay_address Payment address for address edit widget. Used only if `is_new` is `true`:
   ...
   *
   * @post post
   * @type {Wl_Pay_Processor_CyberSource_CsPaSetupModel_a_card}
   */
 ...
 *
 * @function
 * @name Wl_Pay_Processor_CyberSource_CsPaSetupModel.post
