...
function Wl_Collector_DebtListModel()
{
   ...
   *
   * If left `null` and [DebtListApi](/Wl/Collector/DebtList.json) has been specified, only debts added after the start date will be returned.
   * If left `null` and [DebtListApi](/Wl/Collector/DebtList.json) is also `null`, this will return debts from the previous month.
   *
   * @get get
   * @type {?string}
   */
   ...
   *
   * If left `null` and [DebtListApi](/Wl/Collector/DebtList.json) has been specified will return debts added since the beginning of time.
   * If left `null` and [DebtListApi](/Wl/Collector/DebtList.json) is also `null`, this will return debts from the previous month.
   *
   * @get get
   * @type {?string}
