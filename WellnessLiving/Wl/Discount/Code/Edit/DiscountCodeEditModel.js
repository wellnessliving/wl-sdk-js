...
function Wl_Discount_Code_Edit_DiscountCodeEditModel()
{
   ...
   * @property {string} k_id Primary key of the component. <p>Special Notes:</p> <ul>   <li>Zero means that all elements of this type are available.</li>   <li>     For `id_purchase_item`={@link RsPurchaseItemSid} it's class key.
