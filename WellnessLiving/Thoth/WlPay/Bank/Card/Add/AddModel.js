 ...
 */
function Thoth_WlPay_Bank_Card_Add_AddModel()
{
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Bank_Card_Add_AddModel_a_card_detail_a_pay_address
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Bank_Card_Add_AddModel_a_card_detail
   * @property {Thoth_WlPay_Bank_Card_Add_AddModel_a_card_detail_a_pay_address} a_pay_address Address information:
   ...
   *
   * @post post
   * @type {Thoth_WlPay_Bank_Card_Add_AddModel_a_card_detail}
   */
...
WlSdk_ModelAbstract.extend(Thoth_WlPay_Bank_Card_Add_AddModel);

/**
 * @inheritDoc
 */
Thoth_WlPay_Bank_Card_Add_AddModel.prototype.config=function()
{
 ...
 *
 * @function
 * @name Thoth_WlPay_Bank_Card_Add_AddModel.delete
 ...
 *
 * @function
 * @name Thoth_WlPay_Bank_Card_Add_AddModel.get
 * @returns {WlSdk_Deferred_Promise}
 ...
 *
 * @function
 * @name Thoth_WlPay_Bank_Card_Add_AddModel.post
 * @returns {WlSdk_Deferred_Promise}
