 ...
 */
function Wl_Pay_Processor_Nuvei_NuveiTransactionStartModel()
{
  WlSdk_ModelAbstract.apply(this);

  /**
   * @typedef {{}} Wl_Pay_Processor_Nuvei_NuveiTransactionStartModel_a_card_a_pay_address
  ...
  /**
   * @typedef {{}} Wl_Pay_Processor_Nuvei_NuveiTransactionStartModel_a_card
   * @property {Wl_Pay_Processor_Nuvei_NuveiTransactionStartModel_a_card_a_pay_address} a_pay_address Payment address for address edit widget.
   ...
   *
   * @post post
   * @type {?Wl_Pay_Processor_Nuvei_NuveiTransactionStartModel_a_card}
   */
  this.a_card = null;
...
WlSdk_ModelAbstract.extend(Wl_Pay_Processor_Nuvei_NuveiTransactionStartModel);

/**
 * @inheritDoc
 */
Wl_Pay_Processor_Nuvei_NuveiTransactionStartModel.prototype.config=function()
{
 ...
 *
 * @function
 * @name Wl_Pay_Processor_Nuvei_NuveiTransactionStartModel.post
