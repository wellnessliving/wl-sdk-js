...
function Wl_Video_VideoListModel()
{
   ...
   * @property {?string} url_video URL of the video file (HLS stream). `null` if not available. See {@link Wl_Video_VideoElementModel.url_video} for details about the video URL.
   */
