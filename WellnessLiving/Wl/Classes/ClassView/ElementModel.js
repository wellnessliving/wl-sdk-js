...
function Wl_Classes_ClassView_ElementModel()
{
   ...
   * @property {?Wl_Classes_ClassView_ElementModel_a_class_list_a_config} a_config Class-specific business policies overriding the business defaults. Has the same structure as [BusinessConfigApi](/Wl/Business/Config/BusinessConfig.json). `null` when the class uses the default business policy without overrides.
