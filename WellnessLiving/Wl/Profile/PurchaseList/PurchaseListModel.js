...
function Wl_Profile_PurchaseList_PurchaseListModel()
{
   ...
   * @property {string} k_appointment Appointment key. Primary key from {@link \RsAppointmentSql} table.
   ...
   * @property {string} k_service Service key. Primary key in {@link \RsServiceSql} table.
