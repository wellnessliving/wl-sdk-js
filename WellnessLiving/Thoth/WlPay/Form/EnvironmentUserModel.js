...
function Thoth_WlPay_Form_EnvironmentUserModel()
{
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_E_a_terminal_location_a_terminal_a_terminal_elevate
   * @property {boolean} can_cancel_swipe_from_pos Whether swipe can be cancelled from the POS terminal.
   * @property {number} id_model List of {@link Thoth_PayProcessor_PayProcessorSid} supported terminal types.
   * @property {number} id_status List of possible status of readers.
   * @property {number} id_type List of {@link Thoth_PayProcessor_PayProcessorSid} supported terminal types.
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_E_a_terminal_location_a_terminal_a_terminal_web
   * @property {boolean} can_cancel_swipe_from_pos Whether swipe can be cancelled from the POS terminal.
   * @property {number} id_model List of {@link Thoth_PayProcessor_PayProcessorSid} supported terminal types.
   * @property {number} id_status List of possible status of readers.
   * @property {number} id_type List of {@link Thoth_PayProcessor_PayProcessorSid} supported terminal types.
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_E_a_terminal_location_a_terminal
   * @property {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_E_a_terminal_location_a_terminal_a_terminal_elevate} a_terminal_elevate Elevate-model terminals. Each element:
   * @property {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_E_a_terminal_location_a_terminal_a_terminal_web} a_terminal_web Ethernet terminals, plus one synthetic `MagTek` USB entry appended last when {@link Thoth_PayProcessor_Nuvei_Terminal_NuveiTerminalTypeSid} returns `true`. Each element:
   */

  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_E_a_terminal_location
   * @property {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_E_a_terminal_location_a_terminal} a_terminal Terminal lists grouped by connection type. Both lists contain identical entries - the same terminal appears in both.
   * @property {string} text_location_name Display name of the location.
   */

  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_E
   * @property {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_E_a_terminal_location} a_terminal_location Terminal configuration keyed by location key.
   * @property {boolean} can_cancel_swipe_from_pos Whether card swipe can be cancelled from the POS terminal.
   * @property {boolean} has_expire_date Whether the card expiry date entry is required.
   * @property {boolean} has_readers_selection Whether the card reader selection UI is shown.
   * @property {boolean} is_support_magtek Whether `MagTek` USB reader is supported.
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_F_a_terminal_location_a_terminal_a_terminal_elevate
   * @property {boolean} can_cancel_swipe_from_pos Whether swipe can be cancelled from the POS terminal.
   * @property {number} id_model Stripe device type of reader.
   * @property {number} id_status List of possible status of readers.
   * @property {string} k_terminal Terminal key.
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_F_a_terminal_location_a_terminal_a_terminal_web
   * @property {boolean} can_cancel_swipe_from_pos Whether swipe can be cancelled from the POS terminal.
   * @property {number} id_model Stripe device type of reader.
   * @property {number} id_status List of possible status of readers.
   * @property {number} id_type List of {@link Thoth_PayProcessor_PayProcessorSid} supported terminal types.
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_F_a_terminal_location_a_terminal
   * @property {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_F_a_terminal_location_a_terminal_a_terminal_elevate} a_terminal_elevate Elevate-model terminals. Each element:
   * @property {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_F_a_terminal_location_a_terminal_a_terminal_web} a_terminal_web Ethernet terminals. Each element:
   */

  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_F_a_terminal_location
   * @property {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_F_a_terminal_location_a_terminal} a_terminal Terminal lists grouped by connection type:
   * @property {string} s_location_id Stripe location ID assigned by the gateway.
   * @property {string} text_location_name Display name of the location.
   */

  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_F
   * @property {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_F_a_terminal_location} a_terminal_location Terminal configuration keyed by location key.
   * @property {boolean} has_expire_date Whether the card expiry date entry is required.
   * @property {boolean} has_readers_selection Whether the card reader selection UI is shown.
   * @property {boolean} is_support_magtek Whether `MagTek` USB reader is supported.
   */
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_G_a_terminal_location_a_terminal_a_terminal_elevate
   * @property {boolean} can_cancel_swipe_from_pos Whether swipe can be cancelled from the POS terminal.
   * @property {number} id_model Paragon device type of reader.
   * @property {number} id_status List of possible status of readers.
   * @property {string} k_terminal Terminal key.
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_G_a_terminal_location_a_terminal_a_terminal_web
   * @property {boolean} can_cancel_swipe_from_pos Whether swipe can be cancelled from the POS terminal.
   * @property {number} id_model Paragon device type of reader.
   * @property {number} id_status List of possible status of readers.
   * @property {number} id_type List of supported terminal interaction types. Note: this list is rather internal Wellnessliving application list rather than common-known list. Each of types determines the way how we interact with terminal on application level.
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_G_a_terminal_location_a_terminal
   * @property {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_G_a_terminal_location_a_terminal_a_terminal_elevate} a_terminal_elevate Elevate-model terminals. Each element:
   * @property {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_G_a_terminal_location_a_terminal_a_terminal_web} a_terminal_web Ethernet and USB terminals. Always includes one synthetic `MagTek` USB entry appended last. Each element:
   */

  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_G_a_terminal_location
   * @property {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_G_a_terminal_location_a_terminal} a_terminal Terminal lists grouped by connection type:
   * @property {string} text_location_name Display name of the location.
   */

  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_G
   * @property {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_G_a_terminal_location} a_terminal_location Terminal configuration keyed by location key.
   * @property {boolean} can_cancel_swipe_from_pos Whether card swipe can be cancelled from the POS terminal.
   * @property {boolean} has_expire_date Whether the card expiry date entry is required.
   * @property {boolean} has_readers_selection Whether the card reader selection UI is shown.
   * @property {number} id_device A list of devices supported by credit card reader plugin.
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_H
   * @property {number} id_device A list of devices supported by credit card reader plugin.
   * @property {string} s_key NMI SDK key for the card reader plugin.
   */
   ...
   *
   * @get result
   * @type {Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_A|Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_B|Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_C|Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_D|Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_E|Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_F|Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_G|Thoth_WlPay_Form_EnvironmentUserModel_a_mobile_config_H|?*}
   */
