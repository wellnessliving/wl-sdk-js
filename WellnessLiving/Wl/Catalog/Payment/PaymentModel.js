...
function Wl_Catalog_Payment_PaymentModel()
{
   ...
   * @property {string} k_staff <b>Deprecated!</b>
   *   Staff key.
   ...
   * @property {Wl_Catalog_Payment_PaymentModel_a_item_a_config_a_wellness_program_a_account} a_account The list of reimbursement account field values.
   * Corresponds to the `a_account` list in {@link Wl_Insurance_Enrollment_Field_EnrollmentFieldListModel.a_field_list}.
   * Each element:
   * @property {Wl_Catalog_Payment_PaymentModel_a_item_a_config_a_wellness_program_a_field} a_field The list of wellness program field values.
   * Corresponds to the `a_field` list in {@link Wl_Insurance_Enrollment_Field_EnrollmentFieldListModel.a_field_list}.
   * Each element:
   */
  /**
   ...
   * @property {*} [a_tax] List of taxes to be applied to the registration fee.
   * Keys are tax keys.
   ...
   * @property {Wl_Catalog_Payment_PaymentModel_a_item_a_config_a_event_list_a_discount} [a_discount] Discount applied to the event price.
   * Staff-only: ignored when sent by a client.
   * @property {{}} [a_tax] List of taxes to be applied to the event price.
   * Keys are tax keys.
   ...
   * @property {string} [m_checkout] The amount charged for this event at checkout. Staff-only: ignored when sent by a client.
   ...
   * @property {string} [m_price] Price of the event for the tuition participant.
   ...
   * @property {Wl_Catalog_Payment_PaymentModel_a_item_a_config_a_event_list} [a_event_list] List of tuition events. Used only for {@link RsSaleSid.TUITION}.
   ...
   * @property {Wl_Catalog_Payment_PaymentModel_a_item_a_config_a_registration_fee_list} [a_registration_fee_list] Registration fees for tuition participants. Used only for `id_sale` = {@link RsSaleSid.TUITION}.
   ...
   * @property {Wl_Catalog_Payment_PaymentModel_a_item_a_config_a_wellness_program} [a_wellness_program] "Wellness Program" fields.
   ...
   * @property {boolean} [is_pay_when_start] If `true`, the client won't be charged for this item until its start date. Otherwise, this will be `false`.
   ...
   *
   * @property {string} [k_wellness_program] The "Wellness Program" key. Set this for the insurance membership promotion.
   ...
   * </ul>
   * @property {string} [m_checkout] Staff-only: ignored when sent by a client.
   ...
   *
   * @property {string} [m_prorate_custom] The custom prorate price, used only for memberships. This is only used if <tt>is_prorate_fix</tt> is <tt>true</tt>.
