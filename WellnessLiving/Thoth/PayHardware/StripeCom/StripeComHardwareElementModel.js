 ...
 * @constructor
 */
function Thoth_PayHardware_StripeCom_StripeComHardwareElementModel()
{
...
WlSdk_ModelAbstract.extend(Thoth_PayHardware_StripeCom_StripeComHardwareElementModel);

/**
 * @inheritDoc
 */
Thoth_PayHardware_StripeCom_StripeComHardwareElementModel.prototype.config=function()
{
...
/**
 * @function
 * @name Thoth_PayHardware_StripeCom_StripeComHardwareElementModel.instanceGet
 * @param {string} k_business Business key.
 * @returns {Thoth_PayHardware_StripeCom_StripeComHardwareElementModel}
 ...
 *
 * @function
 * @name Thoth_PayHardware_StripeCom_StripeComHardwareElementModel.delete
 ...
 *
 * @function
 * @name Thoth_PayHardware_StripeCom_StripeComHardwareElementModel.get
 * @returns {WlSdk_Deferred_Promise}
 ...
 *
 * @function
 * @name Thoth_PayHardware_StripeCom_StripeComHardwareElementModel.post
 * @returns {WlSdk_Deferred_Promise}
