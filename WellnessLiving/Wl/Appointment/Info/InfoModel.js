...
function Wl_Appointment_Info_InfoModel()
{
   ...
   * @property {string} dl_end Date when the repeat cycle stops, in location timezone. Empty if the repeat cycle does not stop at a certain date.
   * @property {number} i_occurrence Number of occurrences after that the repeat cycle stops. `0` if the repeat cycle does not stop after a certain number of occurrences.
