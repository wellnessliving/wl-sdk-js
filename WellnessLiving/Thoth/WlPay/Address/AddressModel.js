 ...
 * @constructor
 */
function Thoth_WlPay_Address_AddressModel()
{
  ...
  /**
   * @typedef {{}} Thoth_WlPay_Address_AddressModel_a_pay_address
   ...
   *
   * @get result
   * @type {?Thoth_WlPay_Address_AddressModel_a_pay_address[]}
   */
...
WlSdk_ModelAbstract.extend(Thoth_WlPay_Address_AddressModel);

/**
 * @inheritDoc
 */
Thoth_WlPay_Address_AddressModel.prototype.config=function()
{
 ...
 *
 * @function
 * @name Thoth_WlPay_Address_AddressModel.get
