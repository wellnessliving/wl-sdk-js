...
function Wl_Appointment_Book_Service_ServiceListModel()
{
   ...
   * @property {Wl_Appointment_Book_Service_ServiceListModel_a_service_a_config} a_config Appointment-specific business policy overrides. `null` when the service uses the general business policy.
