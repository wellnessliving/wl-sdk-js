...
function Wl_Catalog_StaffApp_CatalogList_CatalogListModel()
{
   ...
   * @property {boolean} is_visit This will be `true` if this Purchase Option is suitable to pay for the visit `k_visit`. Otherwise, this will be `false`. If `k_visit` is empty, this will always be `false`.
