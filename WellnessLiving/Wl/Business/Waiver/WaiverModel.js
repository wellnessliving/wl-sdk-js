...
function Wl_Business_Waiver_WaiverModel()
{
   ...
   * Not necessarily if the user does not already exist. In this case, you need to set {@link Wl_Business_Waiver_WaiverModel}.
   *
   * @get get
   * @type {string}
   */
 ...
 * @param {string} uid User key for which the waiver is shown. Used to fill the variables in the contract Not necessarily if the user does not already exist. In this case, you need to set {@link Wl_Business_Waiver_WaiverModel}.
