...
function Wl_Appointment_Book_Payment_PaymentPostModel()
{
   ...
   * Has the same structure as {@link Wl_Appointment_Book_Payment_PaymentModel.a_book_data}.
   *
   * @post post
  ...
  /**
   * The business key. Currently used only with {@link Wl_Appointment_Book_Payment_PaymentModel.k_session_pass} variable.
   *
   * @get get
   * @type {?string}
   */
