 ...
 * @param {?string} uid_staff User key of a staff member. This is the supported request identifier for staff update operations. Value is normalized into [StaffElementApi](/Wl/Staff/StaffElement.json) in `post()`.
