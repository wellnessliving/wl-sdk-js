...
function Wl_Appointment_Book_Service_ServiceListModel()
{
  ...
  /**
   * @typedef {{}} Wl_Appointment_Book_Service_ServiceListModel_a_service_a_config
  ...
  /**
   * @typedef {{}} Wl_Appointment_Book_Service_ServiceListModel_a_service_a_image
   ...
   * @property {?Wl_Appointment_Book_Service_ServiceListModel_a_service_a_config} a_config Appointment-specific business policy overrides. `null` when the service uses the general business policy. When not `null`, contains a subset of business config fields, including:
   * @property {Wl_Appointment_Book_Service_ServiceListModel_a_service_a_direct_link} a_direct_link A list of links to start booking from a direct link. This can't be one link, as the same appointment can be available in several booking tabs. Therefore, each booking tab has its own direct booking link. Each element has two values:
   * @property {Wl_Appointment_Book_Service_ServiceListModel_a_service_a_image} a_image Information about the appointment image. An array with the following values:
 ...
 *
 * @function
 * @name Wl_Appointment_Book_Service_ServiceListModel.get
