 ...
 * @constructor
 */
function Thoth_WlPay_Transaction_Report_TransactionAllPaymentModel()
{
   ...
   * @property {*} s_batch_number Batch number for this transaction.
   */

  /**
   * @typedef {{}} Thoth_WlPay_Transaction_Report_TransactionAllPaymentModel_a_row
   * @property {Thoth_WlPay_Transaction_Report_TransactionAllPaymentModel_a_row_a_pay_transaction} a_pay_transaction List of pay transactions associated with this row. Each element:
   ...
   * Column positions in each row correspond to the field names in [TransactionAllPaymentApi](/Thoth/WlPay/Transaction/Report/TransactionAllPayment.json).
   *
   * Known columns (use [TransactionAllPaymentApi](/Thoth/WlPay/Transaction/Report/TransactionAllPayment.json) to resolve their positional indexes):
   *
   * @get result
...
WlSdk_ModelAbstract.extend(Thoth_WlPay_Transaction_Report_TransactionAllPaymentModel);

/**
 * @inheritDoc
 */
Thoth_WlPay_Transaction_Report_TransactionAllPaymentModel.prototype.config=function()
{
 ...
 *
 * @function
 * @name Thoth_WlPay_Transaction_Report_TransactionAllPaymentModel.get
