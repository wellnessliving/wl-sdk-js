...
function Wl_Schedule_ScheduleList_StaffApp_ScheduleListModel()
{
  ...
  /**
   * @typedef {{}} Wl_Schedule_ScheduleList_StaffApp_ScheduleListModel_a_config
  ...
  /**
   * @typedef {{}} Wl_Schedule_ScheduleList_StaffApp_ScheduleListModel_a_schedule_a_quiz
  ...
  /**
   * @typedef {{}} Wl_Schedule_ScheduleList_StaffApp_ScheduleListModel_a_schedule_a_staff_info
   * @property {boolean} is_staff_change `true` means staff is substituted, `false` simple staff member.
   * @property {string} k_staff Staff key.  Returned only for applications in the `APPS_USE_OLD_K_STAFF` allow-list.
   ...
   * @property {?Wl_Schedule_ScheduleList_StaffApp_ScheduleListModel_a_schedule_a_quiz} a_quiz List of quizzes. Has next structure:
   * @property {string[]} a_resource A list of assets involved in the session.
   * @property {string[]} a_resource_removed List of removed assets involved in the session.
   * @property {string[]} a_staff A list of staff members who will conduct the session.
   * @property {Wl_Schedule_ScheduleList_StaffApp_ScheduleListModel_a_schedule_a_staff_info} a_staff_info Information about staff members who conduct this session. For applications in the `APPS_USE_OLD_K_STAFF` allow-list, keys are . For other applications, keys are . Values are array with data:
   ...
   * @property {boolean} has_quiz_uncompleted `true` if has uncompleted quizzes, `false` otherwise.
   * @property {number} i_addon The number of addons for the current appointment. Set only if the current session is an appointment.
   ...
   * @property {boolean} show_quiz_icon `true` when need show quiz icon, `false` otherwise.
   * @property {number} t_business_end The latest time the business where the session takes place, closes. In Unix format.
   * @property {number} t_business_start The earliest time the business where the session takes place, opens. In Unix format.
   ...
   * @property {string} text_quiz_title Title for quiz icon.
...
{
  return {"a_field":{"a_config":{"get":{"get":true}},"a_schedule":{"get":{"result":true}},"dl_end":{"get":{"get":true}},"dl_start":{"get":{"get":true}},"dt_date":{"get":{"get":true}},"is_virtual_service":{"get":{"result":true}},"k_business":{"get":{"get":true}},"uid":{"get":{"get":true}}}};
};

/**
 * @function
 * @name Wl_Schedule_ScheduleList_StaffApp_ScheduleListModel.instanceGet
 * @param {string} dt_date The date of the sessions in Coordinated Universal Time (UTC) and MySQL format. If this value is used, then `dl_end` and `dl_start` should not be set.
 ...
 *
 * @function
 * @name Wl_Schedule_ScheduleList_StaffApp_ScheduleListModel.get
