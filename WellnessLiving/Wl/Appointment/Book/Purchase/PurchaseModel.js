 ...
 * @constructor
 * @deprecated Use {@link _Wl_Appointment_Book_Purchase_Purchase72Model} instead.
 */
function Wl_Appointment_Book_Purchase_PurchaseModel()
{
  ...
  /**
   * @typedef {{}} Wl_Appointment_Book_Purchase_PurchaseModel_a_login_promotion_a_restrict
  ...
  /**
   * @typedef {{}} Wl_Appointment_Book_Purchase_PurchaseModel_a_login_promotion_a_restrict_data
   ...
   * @property {Wl_Appointment_Book_Purchase_PurchaseModel_a_login_promotion_a_restrict} a_restrict Data about the shortest restriction period:
   * @property {Wl_Appointment_Book_Purchase_PurchaseModel_a_login_promotion_a_restrict_data} a_restrict_data Data about all restriction periods. Given as an array, where each record has the following structure:
  ...
  /**
   * @typedef {{}} Wl_Appointment_Book_Purchase_PurchaseModel_a_purchase_a_payment
   ...
   * @property {Wl_Appointment_Book_Purchase_PurchaseModel_a_purchase_a_image} a_image Information describing the logo of the purchase option. This value can be false if there is no logo described. Image information will have the following fields:
   * @property {Wl_Appointment_Book_Purchase_PurchaseModel_a_purchase_a_payment} a_payment The set of calculated values for payment:
   ...
   * @property {Wl_Appointment_Book_Purchase_PurchaseModel_a_service_a_purchase} a_purchase List of purchase options selected for the service.    Should be set if a new purchase option is selected for this service.
  ...
  /**
   * @typedef {{}} Wl_Appointment_Book_Purchase_PurchaseModel_a_session_pass
   ...
   *
   * @get result
   * @type {Wl_Appointment_Book_Purchase_PurchaseModel_a_session_pass}
   */
...
{
  return {"a_field":{"a_login_prize":{"get":{"result":true}},"a_login_promotion":{"get":{"result":true}},"a_purchase":{"get":{"result":true}},"a_reward_prize":{"get":{"result":true}},"a_service":{"get":{"get":true}},"a_session_pass":{"get":{"result":true}},"a_uid":{"get":{"get":true}},"dt_date":{"get":{"get":true}},"i_duration":{"get":{"get":true}},"i_height":{"get":{"get":true}},"i_width":{"get":{"get":true}},"id_mode":{"get":{"get":true}},"is_backend":{"get":{"get":true}},"is_single_default":{"get":{"result":true}},"is_walk_in":{"get":{"get":true}},"k_location":{"get":{"get":true,"result":true}},"k_login_promotion":{"get":{"get":true,"result":true}},"k_promotion_default":{"get":{"result":true}},"k_resource":{"get":{"get":true}},"k_service":{"get":{"get":true}},"k_timezone":{"get":{"get":true}},"text_login_promotion":{"get":{"result":true}},"uid":{"get":{"get":true}}}};
};
 ...
 * @param {string} k_service The service key used to select available Purchase Options. If multiple services are selected, they should be specified in [PurchaseApi](/Wl/Appointment/Book/Purchase/Purchase.json) array.
 ...
 * @param {?string} k_timezone The timezone key for [PurchaseApi](/Wl/Appointment/Book/Purchase/Purchase.json). Can be `null` if timezone is not selected. If not selected, the default client timezone will be used. In any case, the timezone will be used if the business allows client timezones.
 ...
 *
 * @function
 * @name Wl_Appointment_Book_Purchase_PurchaseModel.get
