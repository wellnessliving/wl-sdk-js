...
function Wl_Appointment_Book_Payment_PaymentMultipleModel()
{
   ...
   * @property {Wl_Appointment_Book_Payment_PaymentMultipleModel_a_book_data_a_provider_a_product} a_product The add-on list. Keys are add-on option keys.
   ...
   * @property {Wl_Appointment_Book_Payment_PaymentMultipleModel_a_book_data_post_a_provider_a_product} a_product The add-on list. Keys are add-on option keys.
   * Values are quantities:
   * @property {number} i_duration The asset duration in minutes. This won't be empty for asset bookings.
   * @property {number} id_purchase_item The ID of the purchase item. One of the {@link Wl_Purchase_Item_ItemSid} constants.
   * This won't be empty for new options purchased.
   ...
   * @property {number} id_purchase_item The purchase item ID. One of the {@link Wl_Purchase_Item_ItemSid} constants.
   ...
   * @property {Wl_Appointment_Book_Payment_PaymentMultipleModel_a_purchase_provider_a_tax} a_tax A list of taxes to apply containing information about taxes.
   * The array keys are <tt>k_tax</tt> keys. Each element contains the following fields:
   * @property {number} id_purchase_item The purchase item ID. One of the {@link Wl_Purchase_Item_ItemSid} constants.
   * @property {string} k_id The value of the discount used for the purchase.
   * @property {string} m_discount The value of the discount used for the purchase.
   ...
   * @type {string}
   */
  this.k_login_activity_purchase = "0";
