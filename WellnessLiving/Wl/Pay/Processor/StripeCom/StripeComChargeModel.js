 ...
 * @constructor
 */
function Wl_Pay_Processor_StripeCom_StripeComChargeModel()
{
  ...
  /**
   * @typedef {{}} Wl_Pay_Processor_StripeCom_StripeComChargeModel_o_payment_method_details
   ...
   *
   * @get result
   * @type {Wl_Pay_Processor_StripeCom_StripeComChargeModel_o_payment_method_details}
   */
...
WlSdk_ModelAbstract.extend(Wl_Pay_Processor_StripeCom_StripeComChargeModel);

/**
 * @inheritDoc
 */
Wl_Pay_Processor_StripeCom_StripeComChargeModel.prototype.config=function()
{
 ...
 *
 * @function
 * @name Wl_Pay_Processor_StripeCom_StripeComChargeModel.get
