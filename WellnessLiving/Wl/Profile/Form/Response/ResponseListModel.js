...
function Wl_Profile_Form_Response_ResponseListModel()
{
   ...
   * @property {number} id_source Place where request to fill out a quiz form occurred.
   ...
   *  <dd>Place where request to fill out a quiz form occurred.</dd>
