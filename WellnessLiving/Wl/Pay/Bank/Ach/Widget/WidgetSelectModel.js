 ...
 * @constructor
 */
function Wl_Pay_Bank_Ach_Widget_WidgetSelectModel()
{
  ...
  /**
   * @typedef {{}} Wl_Pay_Bank_Ach_Widget_WidgetSelectModel_a_pay_bank
   ...
   *
   * @get result
   * @type {Wl_Pay_Bank_Ach_Widget_WidgetSelectModel_a_pay_bank}
   */
...
WlSdk_ModelAbstract.extend(Wl_Pay_Bank_Ach_Widget_WidgetSelectModel);
...
/**
 * @function
 * @name Wl_Pay_Bank_Ach_Widget_WidgetSelectModel.instanceGet
 ...
 * @returns {Wl_Pay_Bank_Ach_Widget_WidgetSelectModel}
 ...
 *
 * @function
 * @name Wl_Pay_Bank_Ach_Widget_WidgetSelectModel.get
